...
import logging
import clip
from model.DynamicScaleNegAugCapGenerator import DynamicScaleNegAugCLIPTextGenerator
import torch
import os
...
def get_parser():
    ...
    parser.add_argument("--scheduler_type", type=DynamicScaleNegAugCLIPTextGenerator.SchedType, default='cosine')
...
def main():
    ...
    text_generator = DynamicScaleNegAugCLIPTextGenerator(**vars(args))
