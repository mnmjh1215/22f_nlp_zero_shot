...
def get_parser():
    ...
    parser.add_argument("--delta_path", default=None)
    return parser
...
def main():
    ...
    if args.debug:
        print("[Debug Mode] only evaluate on 10 test images")
        coco_test = coco_test[:10]
    ...
    results['overall'] = {'best_clip': mean_best_clip, 'best_mixed': mean_best_mixed}
    print("Best CLIP:", mean_best_clip)
    print("Best Mixed:", mean_best_mixed)
