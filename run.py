...
from model.ModifiedCapGenerator import ModifiedCLIPTextGenerator
from model.ModifiedCapGeneratorV2 import ModifiedCLIPTextGeneratorV2
from model.ModifiedCapGenerator_adaptive_reward import ModifiedCLIPTextGenerator_AdaptiveReward
import torch
import os
...
def get_parser():
    ...
    parser.add_argument("--model_class", type=str, default='CLIPTextGenerator',
                        choices=['CLIPTextGenerator', 'ModifiedCLIPTextGenerator', 'ModifiedCLIPTextGeneratorV2', 'ModifiedCLIPTextGenerator_AdaptiveReward'])
...
def run_video(args, video_path):
    ...
    text_generator = get_model_class(args.model_class)(**vars(args))
